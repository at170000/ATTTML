 ...
 * @flow
 */
'use strict';const EventEmitter=require(_0x3248('0x0'));const RCTDeviceEventEmitter=require(_0x3248('0x1'));class NativeEventEmitter extends EventEmitter{ constructor(){ super(RCTDeviceEventEmitter['sharedSubscriber']);}}module[_0x3248('0x2')]=NativeEventEmitter;/*obf_aug_end_0095*/